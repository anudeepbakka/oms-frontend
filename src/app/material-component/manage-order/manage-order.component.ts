...
export class ManageOrderComponent implements OnInit {
  ...
  getCategorys() {
    this.category.getCategorys().subscribe((res) => {
      this.categorys = res;
    }, (error: any) => {
  ...
  getProductsByCategory(value: any) {
    this.product.getByCtegory(value.id).subscribe((response: any) => {
  ...
  add() {
    ...
    if (productName === undefined) {
      ...
      this.dataSource.push({
        ...
        category: formData.category.name, quantity: formData.quantity, price: formData.price,
  ...
  downloadExcel(){
    ...
    this.bill.generateReportExcel(data).subscribe(
      (data: Blob) => {
